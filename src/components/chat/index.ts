    ...
    constructor({ ...props }: ChatProps) {
        ...
        onDropdownAddUser: async () => {
            ...
            this.refs.addUser.refs.error.setProps({
                validateMessage: 'There is no user',
            });
            }
            if (AddUserId) {
                ...
                {{#if selectedChat}}
                    ...
                    <div class="chat-wrap">
                        <div class="chat-recipient">
                                ...
                                <div class="chat-button-align dropdown">
                                    ...
                                    <div id="dropdownChat" class="dropdown-content">
                                        {{{Button label="Add user" styles="dropdown-button" onClick=onModalOpenAddUser}}}
                                        {{{Button label="Delete user" styles="dropdown-button" onClick=onModalOpenDelUser}}}
                                        {{{Button label="Change avatar" styles="dropdown-button" onClick=onModalOpenAddAvatar}}}
                                        {{{Button label="Delete chat" styles="dropdown-button" onClick=onModalOpenDelChat}}}
                                    </div>
                                </div>
                        ...
                        {{#Modal id="ModalDelChat"}}
                            {{#Form  title="Delete chat" formWrap="form-login-wrap"}}
                                {{{Button
                                        label="Are you sure?"
                                        styles="button-form"
                        ...
                        {{#Modal id="ModalDelUser"}}
                            {{#Form  title="Delete user" formWrap="form-login-wrap"}}
                        ...
                        {{#Modal id="ModalAddUser"}}
                            {{#Form  title="New user" formWrap="form-login-wrap"}}
                        ...
                        {{#Modal id="ModalAddAvatar"}}
                            {{#Form  title="Change avatar" formWrap="form-login-wrap"}}
